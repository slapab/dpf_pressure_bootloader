...
// Device doesn't have LF crystal, so the LF should be synthesized from the HF crystal
#define NRF_CLOCK_LFCLKSRC { \
        .source = NRF_CLOCK_LF_SRC_SYNTH, \
        .xtal_accuracy = 250LL /*NRF_CLOCK_LF_XTAL_ACCURACY_50_PPM*/ \
    };
...
#define BSP_LED_0 LED_1         // Is using in dfu macro: ADVERTISING_LED_PIN_NO
#define BSP_ERROR_LED BSP_LED_0
